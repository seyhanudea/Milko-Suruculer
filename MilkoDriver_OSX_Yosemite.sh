...
sudo bash -c 'cat >  /usr/libexec/SmartCardServices/drivers/ifd-ccid.bundle/Contents/Info.plist  << EOF
...
<dict>
	...
	<array>
		...
		<string>SpringCard ProxRoll</string>
		<string>SpringCard NFCRoll</string>
